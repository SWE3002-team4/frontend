...
export function ReviewHeader({ finalScore, subjectTitle, subjectId }: ReviewHeaderProps) {
  return (
    <header className="flex-none px-4 md:px-8 py-3 border-b border-gray-200 bg-white z-20">
      <div className="flex items-center justify-between max-w-4xl mx-auto">
         <div className="flex items-center gap-3">
           <Link href={`/subject/${subjectId}`} className="text-gray-500 hover:text-gray-700 transition-colors p-1 bg-gray-50 rounded">
